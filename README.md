...
<p align="center">
  ...
  <img src="https://raw.githubusercontent.com/PennyLaneAI/pennylane/update-readme-image/doc/_static/pl-logo-lightmode.png#gh-light-mode-only" width="700px">
    <!--
    Use a relative import for the dark mode image. When loading on PyPI, this
    will fail automatically and show nothing.
    -->
    <img src="./doc/_static/pl-logo-darkmode.png#gh-dark-mode-only" width="700px" onerror="this.style.display='none'" alt=""/>
</p>
