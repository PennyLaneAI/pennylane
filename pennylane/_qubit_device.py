    ...
    * :meth:`~.expval`, :meth:`~.var`, :meth:`~.sample`: return expectation values,
    ...
    def statistics(
        ...
        for m in measurements:
            ...
            elif obs.return_type in (_Counts, _AllCounts):
                results.append(
            ...
            elif obs.return_type is _VnEntropy:
            ...
            elif obs.return_type is _MutualInfo:
                if self.wires.labels != tuple(range(self.num_wires)):
                    raise qml.QuantumFunctionError(
            ...
            elif obs.return_type is _Shadow:
                if len(measurements) > 1:
                    raise qml.QuantumFunctionError(
            ...
            elif obs.return_type is _ShadowExpval:
                if len(measurements) > 1:
                    raise qml.QuantumFunctionError(
                        "Classical shadows cannot be returned in combination"
                        " with other return types"
