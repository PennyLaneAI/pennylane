...
class QubitDevice(Device):
    ...
    * :meth:`~.expval`, :meth:`~.var`, :meth:`~.sample`: return expectation values,
    ...
    def __init__(self, wires=1, shots=None, custom_ops=None, cache=0, analytic=None):
        super().__init__(wires=wires, shots=shots, custom_ops=custom_ops, analytic=analytic)
