...
class QubitDevice(Device):
    ...
    * :meth:`~.expval`, :meth:`~.var`, :meth:`~.sample`: return expectation values,
    ...
    Args:
        ...
        shots (None, int): Default number of circuit evaluations/measurement samples used by this device to estimate
            the output. Must be larger than zero. Simulator devices can accept None, which
            corresponds to the limit of infinitely many measurements or analytic calculations of the output.
    """
    ...
    def sample_basis_states(self, number_of_states, state_probability):
        ...
        if self.shots is None:
            raise ValueError("Cannot sample if shots is None.")
    ...
    def sample(self, observable):
        ...
        if self.shots is None:
            raise ValueError("Sample measurements require the number of shots to be defined.")
