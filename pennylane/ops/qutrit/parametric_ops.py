...
class TRX(Operation):
    ...
    **Example**
    ...
    >>> qml.TRX(torch.tensor(0.5), wires=0, subspace=[0, 1]).matrix()
    tensor([[0.9689+0.0000j, 0.0000-0.2474j, 0.0000+0.0000j],
            [0.0000-0.2474j, 0.9689+0.0000j, 0.0000+0.0000j],
    ...
    tensor([[1.0000+0.0000j, 0.0000+0.0000j, 0.0000+0.0000j],
            ...
            [0.0000+0.0000j, 0.0000-0.2474j, 0.9689+0.0000j]])
    """
    num_wires = 1
    num_params = 1
