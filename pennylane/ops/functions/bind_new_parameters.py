...
def bind_new_arguments(
    ...
    compilable_args: dict[str, Any]=None,
) -> Operator2:
    new_args = {
        ...
        "compilable_args": compilable_args,
    }
    def _get_most_recent_args(args_name):
        return new_args[args_name] if new_args[args_name] != getattr(op, args_name) and new_args[args_name] is not None else getattr(op, args_name)
    final_args = (_get_most_recent_args("dynamic_args")
