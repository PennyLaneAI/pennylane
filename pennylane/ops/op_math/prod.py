...
# Same decomposition but with dynamic wire allocation, auto-generated by
# ``make_dynamic_work_wires_rule`` from the explicit-work-wires rule above.
_controlled_product_with_allocated_work_wires = make_dynamic_work_wires_rule(
...
# Same decomposition but with dynamic wire allocation, auto-generated by
# ``make_dynamic_work_wires_rule`` from the explicit-work-wires rule above.
_controlled_product_with_one_allocated_work_wire = make_dynamic_work_wires_rule(
