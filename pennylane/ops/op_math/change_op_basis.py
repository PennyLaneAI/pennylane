...
def _adjoint_change_op_basis_decomp(*_, base, **__):
    queuing.requeue_op(base.operands[2])
    adjoint(queuing.requeue_op(base.operands[1]))
    queuing.requeue_op(base.operands[0])
...
def _controlled_change_op_basis_decomposition(
    ...
    **__,
    ...
    queuing.requeue_op(base.operands[2])
    ctrl(
        queuing.requeue_op(base.operands[1]),
