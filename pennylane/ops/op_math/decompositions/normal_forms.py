...
def _ma_normal_form(
...
) -> list[qml.operation.Operator] | tuple[int, tuple[int, ...], int]:
    ...
    Returns:
        List[qml.operation.Operator, ...] | tuple[int, tuple[int, ...], int]: The decomposition of the SO(3) matrix into Matsumoto-Amano normal forms.
    """
