...
from pennylane.labs.vibrational_ham import BoseWord, BoseSentence, unary_mapping
...
BOSE_WORDS_AND_OPS = [
    ...
    (
        ...
        4,
        (
            [0.25, -0.25j, 0.25j, (0.25+0j), 0.3535533905932738, -0.3535533905932738j, 0.3535533905932738j, (0.3535533905932738+0j), 0.4330127018922193, -0.4330127018922193j, 0.4330127018922193j, (0.4330127018922193+0j)],
            [
                X(0)@X(1),
                X(0)@Y(1),
                Y(0)@X(1),
    ...
    (
        ...
        4,
        (
            [0.25, 0.25j, -0.25j, (0.25+0j), 0.7071067811865477, 0.7071067811865477j, -0.7071067811865477j, (0.7071067811865477+0j), 1.2990381056766578, 1.2990381056766578j, -1.2990381056766578j, (1.2990381056766578+0j)],
[X(0)@X(1),
 X(0)@Y(1),
 Y(0)@X(1),
 Y(0)@Y(1),
...
Y(2)@Y(3)]
    ...
    (
        ...
        4,
        (
            [9.0, -1.5, -3.000000000000001, -4.499999999999999, -1.5, 0.25, 0.5000000000000001, 0.7499999999999999, -3.000000000000001, 0.5000000000000001, 1.0000000000000004, 1.5, -4.499999999999999, 0.7499999999999999, 1.5, 2.2499999999999996],
            [
                I(),
                Z(5),
                Z(6),
...
BOSE_SEN_AND_OPS = [
    (
        ...
        4,
        (
            [0.25, -0.25j, 0.25j, (0.25+0j), 0.3535533905932738, -0.3535533905932738j, 0.3535533905932738j, (0.3535533905932738+0j), 0.4330127018922193, -0.4330127018922193j, 0.4330127018922193j, (0.4330127018922193+0j), -3.0, 0.5, 1.0000000000000002, 1.4999999999999998],
            [
                X(0)@X(1),
                X(0)@Y(1),
                Y(0)@X(1),
...
@pytest.mark.parametrize(
    ...
    [
        (
            BoseWord({(0, 0): "+"}),
            {0: 1, 1: 2},
            ([0.25,-0.25j,0.25j,(0.25+0j)], [X(1)@X(2),X(1)@Y(2),Y(1)@X(2), Y(1)@Y(2)]),
        ),
        (
            BoseSentence({BoseWord({(0, 0): "-"}): 1.0, BoseWord({(0, 1): "+"}): 1.0}),
            {0: "a", 1: "b", 2: "c", 3: "d"},
