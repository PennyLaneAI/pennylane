...
"""Tests for the commutator class function."""
...
def test_replacement():
    """Test the replace_node function"""
...
def test_replacement_too_many():
    """Test that the replace_node function properly raises an exception"""
    A = SymbolNode("A", 1)
    B = SymbolNode("B", 1)
    C = SymbolNode("C", 1)
    D = SymbolNode("D", 1)
