...
class TestLabsQFT:
    ...
    def test_resources_phasegrad(self, num_wires, expected_res):
        ...
        assert _test_decomp_equal(actual_decomp, expected_res)
...
class TestLabsAQFT:
    ...
    def test_resources(self, order, num_wires, expected_res):
        ...
        assert _test_decomp_equal(qre.aqft_resource_decomp(order, num_wires), expected_res)
...
class TestLabsQROMStatePreparation:
    ...
    def test_default_resources(
        ...
        assert _test_decomp_equal(actual_resources, expected_res)
