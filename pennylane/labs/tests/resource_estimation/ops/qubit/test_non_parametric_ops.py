...
class TestHadamard:
    ...
    ctrl_data = (
        (
            ...
            [1],
            [
                re.GateCount(re.ResourceCH.resource_rep(), 1),
            ],
        ),
        (
            ["c1"],
        ...
        (
            ...
            [
                ...
                re.GateCount(re.ResourceMultiControlledX.resource_rep(2, 0), 1),
            ],
        ),
        (
            ["c1", "c2", "c3"],
            ...
            [
                re.GateCount(re.ResourceHadamard.resource_rep(), 2),
                re.GateCount(re.ResourceRY.resource_rep(), 2),
                re.GateCount(re.ResourceMultiControlledX.resource_rep(3, 2), 1),
            ],
        ),
    )
...
class TestT:
    ...
    def test_adjoint_decomposition(self):
        ...
        assert t_dag.resource_decomp(**t_dag.resource_params) == expected
...
class TestX:
    ...
    ctrl_data = (
        ...
        (
            ...
            [0, 0],
            [
                re.GateCount(re.ResourceX.resource_rep(), 4),
                re.GateCount(re.ResourceToffoli.resource_rep(), 1),
            ],
        ),
        (
    ...
    def test_adjoint_decomposition(self):
        ...
        r1 = re.estimate_resources(x)
        r2 = re.estimate_resources(x_dag)
        assert r1 == r2
...
class TestY:
    ...
    def test_resources(self):
        ...
        expected = [
            ...
            re.GateCount(
                re.resource_rep(re.ResourceAdjoint, {"base_cmpr_op": re.resource_rep(re.ResourceS)})
            ),
    ...
    ctrl_data = (
        (
            ...
            [1],
            [
                re.GateCount(re.ResourceCY.resource_rep(), 1),
            ],
        ),
        (
            ["c1"],
        ...
        (
            ...
            [
                ...
                re.GateCount(
                    re.resource_rep(
                        re.ResourceAdjoint, {"base_cmpr_op": re.ResourceS.resource_rep()}
                    ),
                    1,
                ),
                re.GateCount(re.ResourceMultiControlledX.resource_rep(2, 0), 1),
        ...
        (
            ...
            [
                ...
                re.GateCount(re.ResourceMultiControlledX.resource_rep(2, 2), 1),
            ],
        ),
        (
            ["c1", "c2", "c3"],
    ...
    def test_adjoint_decomposition(self):
        ...
        r1 = re.estimate_resources(y)
        r2 = re.estimate_resources(y_dag)
        assert r1 == r2
...
class TestZ:
    ...
    ctrl_data = (
        ...
        (
            ...
            [1, 1],
            [
                re.GateCount(re.ResourceCCZ.resource_rep(), 1),
            ],
        ),
        (
            ["c1", "c2"],
    ...
    def test_adjoint_decomposition(self):
        ...
        r1 = re.estimate_resources(z)
        r2 = re.estimate_resources(z_dag)
        assert r1 == r2
