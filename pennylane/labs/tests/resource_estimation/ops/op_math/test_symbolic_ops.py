...
class TestResourceAdjoint:
    ...
    def test_resource_decomp(self):
        ...
        assert adj_op.default_resource_decomp(**adj_op.resource_params) == expected_res
    ...
    def test_adj_resource_decomp(self, base_op):
        ...
        assert adj_adj_op.default_resource_decomp(**adj_adj_op.resource_params) == expected_res
...
class TestResourcePow:
    ...
    def test_resource_decomp(self):
        ...
        z_and_expected_res = (
            ...
            (2, op.default_pow_resource_decomp(2, **op.resource_params)),
            (3, op.default_pow_resource_decomp(3, **op.resource_params)),
        )

        for z, res in z_and_expected_res:
            pow_op = plre.ResourcePow(op, z)
            assert pow_op.default_resource_decomp(**pow_op.resource_params) == res
        ...
        assert pow_op.default_resource_decomp(**pow_op.resource_params) == expected_res
    ...
    def test_pow_resource_decomp(self, base_op, z):
        ...
        assert pow_pow_op.default_resource_decomp(**pow_pow_op.resource_params) == expected_res
...
class TestResourceControlled:
    ...
    def test_resource_decomp(self):
        ...
        ctrl_params_and_expected_res = (
            ((1, 0), op.default_controlled_resource_decomp(1, 0, **op.resource_params)),
            ((2, 0), op.default_controlled_resource_decomp(2, 0, **op.resource_params)),
            ((3, 2), op.default_controlled_resource_decomp(3, 2, **op.resource_params)),
        )

        for (ctrl_wires, ctrl_values), res in ctrl_params_and_expected_res:
            ctrl_op = plre.ResourceControlled(op, ctrl_wires, ctrl_values)
            assert ctrl_op.default_resource_decomp(**ctrl_op.resource_params) == res
        ...
        assert ctrl_op.default_resource_decomp(**ctrl_op.resource_params) == expected_res
    ...
    def test_ctrl_resource_decomp(self, ctrl_wires, ctrl_values, base_op):
        ...
        assert ctrl_ctrl_op.default_resource_decomp(**ctrl_ctrl_op.resource_params) == expected_res
...
class TestResourceProd:
    ...
    def test_resource_decomp(self):
        ...
        assert prod_op.default_resource_decomp(**prod_op.resource_params) == expected_res
...
class TestResourceChangeBasisOp:
    ...
    def test_resource_decomp(self):
        ...
        assert cb_op.default_resource_decomp(**cb_op.resource_params) == expected_res
