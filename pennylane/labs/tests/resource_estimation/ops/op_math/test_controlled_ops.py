...
class TestResourceCH:
    ...
    def test_resources(self):
        ...
        assert self.op.resource_decomp(rc, **self.op.resource_params) == expected_resources
    ...
    def test_resource_adjoint(self):
        ...
        assert self.op.adjoint_resource_decomp(rc) == expected_res
    ...
    def test_resource_pow(self, z, expected_res):
        ...
        assert self.op.pow_resource_decomp(rc, z) == expected_res
...
class TestResourceMultiControlledX:
    ...
    def test_resources(self, params, expected_res):
        ...
        assert re.ResourceMultiControlledX.resource_decomp(rc, **op_resource_params) == expected_res
    ...
    def test_resource_adjoint(self):
        ...
        assert op.adjoint_resource_decomp(rc, **op.resource_params) == expected_res
...
class TestResourceControlledPhaseShift:
    ...
    def test_resources_from_rep(self):
        ...
        assert op_compressed_rep_type.resource_decomp(rc, **op_resource_params) == expected
    ...
    def test_adjoint_decomp(self):
        ...
        assert op.default_adjoint_resource_decomp(rc) == [
    ...
    def test_pow_decomp(self, z, expected_res):
        ...
        op = re.ResourceControlledPhaseShift
        assert op.default_pow_resource_decomp(rc, z) == expected_res
