...
def test_resource_trotter_cdf(num_orbitals, num_fragments, num_steps, order, expected_res):
    """Test the ResourceTrotterCDF class for compressed double factorization"""
    compact_ham = plre.CompactHamiltonian.from_cdf(
...
def test_resource_trotter_thc(num_orbitals, tensor_rank, num_steps, order, expected_res):
    """Test the ResourceTrotterTHC class for tensor hypercontraction"""
    compact_ham = plre.CompactHamiltonian.from_thc(
