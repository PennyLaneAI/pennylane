...
from pennylane.labs.condensed_vibrational.utils import setup_environment_wrapper, snapshot_and_average
...
def condensed_vibrational_pes(
    ...
    **Example**
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        # Initialize QMM workflow for condensed phase calculations
        qmm_workflow = setup_environment_wrapper(mol_eq, **kwargs)
