...
molecule = qml.qchem.Molecule(
    sym, geometry, basis_name="6-31g", unit="Angstrom", load_data=load_data
)
pes = vibrational_ham.vibrational_pes(
    molecule, quad_order=9, localize=localize, do_cubic=True, get_anh_dipole=3
)
