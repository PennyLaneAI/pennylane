...
class SymbolNode(ASTNode):
    ...
    def is_zero(self) -> bool:
        coeffs = [coeff for _, coeff in self.symbols]
        return all(np.isclose(coeffs, 0))
...
def merge(node1: ASTNode, node2: ASTNode, k: int):
    """
...
def _replace_node_impl(source_node: ASTNode, target_node: ASTNode, new_nodes: List[ASTNode]):
    """
