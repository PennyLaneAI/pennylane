...
class VibronicMatrix(Fragment):
    ...
    **Example**
    ...
    def set_block(self, row: int, col: int, rs_sum: RealspaceSum) -> None:
        ...
        >>> vib
        VibronicMatrix({(0, 0): RealspaceSum((RealspaceOperator(5, (), 1), RealspaceOperator(5, 'Q', phi[idx0]))), (1, 1): RealspaceSum((RealspaceOperator(5, (), 1), RealspaceOperator(5, 'Q', phi[idx0])))})
        """
