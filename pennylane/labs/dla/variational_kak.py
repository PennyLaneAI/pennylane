...
def variational_kak_adj(H, g, dims, adj, verbose=False, opt_kwargs=None, pick_min=False):
    ...
    see eq. (6) therein and our `demo <demos/tutorial_fixed_depth_hamiltonian_simulation_via_cartan_decomposition>` for more details.
    ...
    .. seealso:: `The KAK decomposition in theory (demo) <demos/tutorial_kak_decomposition>`, `The KAK decomposition in practice (demo) <demos/tutorial_fixed_depth_hamiltonian_simulation_via_cartan_decomposition>`.
