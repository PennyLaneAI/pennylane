...
def cartan_subalgebra(
    ...
    .. seealso:: :func:`~cartan_decomp`, :func:`~structure_constants`, `The KAK decomposition (demo) <https://pennylane.ai/qml/demos/tutorial_kak_decomposition>`__, :doc:`The KAK decomposition (demo) </demos/tutorial_kak_theorem>`.
