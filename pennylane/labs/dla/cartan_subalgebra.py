...
def cartan_subalgebra(
    ...
    .. seealso:: :func:`~cartan_decomp`, :func:`~structure_constants`, `The KAK decomposition  theory(demo) <https://pennylane.ai/qml/demos/tutorial_kak_decomposition>`__, :doc:`The KAK decomposition in practice (demo) <demos/tutorial_fixed_depth_hamiltonian_simulation_via_cartan_decomposition>`.
