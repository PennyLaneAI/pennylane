...
def structure_constants_dense(g: TensorLike, is_orthonormal: bool = True) -> TensorLike:
    ...
    .. seealso:: For details on the mathematical definitions, see :func:`~structure_constants` and the section "Lie algebra basics" in our :ref:`g-sim demo <demos/tutorial_liesim<Lie algebra basics>>`.
