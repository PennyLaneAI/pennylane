...
class ResourceUniformStatePrep(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_resource_decomp(cls, config, num_states):
...
class ResourceAliasSampling(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_resource_decomp(cls, config, num_coeffs, precision=None) -> list[GateCount]:
        r"""Returns a list representing the resources of the operator. Each object in the list represents a gate and the
        number of times it occurs in the circuit.
        ...
        precision = precision or config.conf["precision_alias_sampling"]
    ...
    **Example**
    ...
    def default_resource_decomp(
        ...
        Returns:
            ...
            in the decomposition.
        """
        precision = precision or config.conf["precision_mps_prep"]
        num_work_wires = min(
...
class ResourceQROMStatePreparation(ResourceOperator):
    ...
    **Example**
    ...
    def _decomp_selection_helper(
        ...
        """
        gate_counts = []
        precision = precision or config.conf["precision_qrom_state_prep"]
    ...
    @classmethod
    def default_resource_decomp(
        cls, config, num_state_qubits, positive_and_real, precision=None, selswap_depths=1
    ):
        r"""Returns a list representing the resources of the operator. Each object in the list
        represents a gate and the number of times it occurs in the circuit.
...
class ResourcePrepTHC(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_resource_decomp(
        cls, config, compact_ham, coeff_precision=None, select_swap_depth=None
    ) -> list[GateCount]:
        ...
        coeff_precision = coeff_precision or config.conf["qubitization_coeff_precision"]
