...
def sparse_matrix(one_body, two_body, tol_factor):
    '''
    Args:
    ...
    adjusted_one_body_coeffs = one_body - 0.5 * np.einsum("illj", two_body) + np.einsum("llij", two_body)
...
def double_factorization(one_body, two_body, tol_factor):
    '''
    Args:
        one_body (np.array): 2-tensor with the one body intergrals in chemistry notation
        two_body (np.array): 4-tensor with the two body intergrals in chemistry notation
...
def compressed_double_factorization(one_body, two_body, tol_factor):
    '''
    Args:
        one_body (np.array): 2-tensor with the one body intergrals in chemistry notation
        two_body (np.array): 4-tensor with the two body intergrals in chemistry notation
    ...
    __, cores, __ = qml.qchem.factorize(two_body, 
                                        tol_factor=tol_factor,  
                                        compressed=True, 
                                        regularization="L1")
    num_terms_two_body = len(cores)
    one_norm_two_body = np.sum(abs(core_el) for core_el in cores)
...
def l4(one_body, two_body, tol_factor):
    '''
    Args:
        one_body (np.array): 2-tensor with the one body intergrals in chemistry notation
        two_body (np.array): 4-tensor with the two body intergrals in chemistry notation
