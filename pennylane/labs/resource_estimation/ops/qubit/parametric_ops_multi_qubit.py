...
class ResourceMultiRZ(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_resource_decomp(cls, config, num_wires, eps=None):
    ...
    def resource_rep(cls, num_wires, eps=None):
        ...
        """
        return CompressedResourceOp(cls, num_wires, {"num_wires": num_wires, "eps": eps})

    @classmethod
    def default_adjoint_resource_decomp(cls, config, num_wires, eps=None) -> list[GateCount]:
    ...
    @classmethod
    def default_pow_resource_decomp(cls, config, pow_z, num_wires, eps=None) -> list[GateCount]:
...
class ResourcePauliRot(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_resource_decomp(cls, config, pauli_string, eps=None):
    ...
    def resource_rep(cls, pauli_string, eps=None):
        ...
        return CompressedResourceOp(cls, num_wires, {"pauli_string": pauli_string, "eps": eps})

    @classmethod
    def default_adjoint_resource_decomp(cls, config, pauli_string, eps=None) -> list[GateCount]:
        r"""Returns a list representing the resources for the adjoint of the operator.
...
class ResourceIsingXX(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_adjoint_resource_decomp(cls, config, eps=None) -> list[GateCount]:
        r"""Returns a list representing the resources for the adjoint of the operator.
...
class ResourceIsingYY(ResourceOperator):
    ...
    **Example**
    ...
    @classmethod
    def default_pow_resource_decomp(cls, config, pow_z, eps=None) -> list[GateCount]:
        r"""Returns a list representing the resources for an operator raised to a power.
