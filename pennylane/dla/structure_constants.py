...
def structure_constants(dla):
    ...
    Args:
        dla (List[PauliSentence]): The (dynamical) Lie algebra for which we want to compute its adjoint representation. DLAs can be generated by a set of generators via :func:`~lie_closure`
