...
:math:`SU(2^n)` is a Lie group and has an associated `Lie algebra <https://pennylane.ai/qml/demos/tutorial_liealgebra>`__
...
* `Introducing (dynamical) Lie algebras for quantum practitioners <https://pennylane.ai/qml/demos/tutorial_liealgebra>`__
* `g-sim: Lie-algebraic classical simulations for variational quantum computing <https://pennylane.ai/qml/demos/tutorial_liesim>`__
* `(g + P)-sim: Extending g-sim by non-DLA observables and gates <https://pennylane.ai/qml/demos/tutorial_liesim_extension>`__
* `Fixed depth Hamiltonian simulation via Cartan decomposition <https://pennylane.ai/qml/demos/tutorial_fixed_depth_hamiltonian_simulation_via_cartan_decomposition>`__
* `The KAK decomposition <https://pennylane.ai/qml/demos/tutorial_kak_decomposition>`__
