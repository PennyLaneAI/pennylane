...
:math:`SU(2^n)` is a Lie group and has an associated `Lie algebra <demos/tutorial_liealgebra>`
...
* `Introducing (dynamical) Lie algebras for quantum practitioners <demos/tutorial_liealgebra>`
* `g-sim: Lie-algebraic classical simulations for variational quantum computing <demos/tutorial_liesim>`
* `(g + P)-sim: Extending g-sim by non-DLA observables and gates <demos/tutorial_liesim_extension>`
* `Fixed depth Hamiltonian simulation via Cartan decomposition <demos/tutorial_fixed_depth_hamiltonian_simulation_via_cartan_decomposition>`
* `The KAK decomposition <demos/tutorial_kak_decomposition>`
