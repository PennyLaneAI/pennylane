...
def _validate_cotangents(cotangents, out_avals):
    import pennyjax as jax  # pylint: disable=import-outside-toplevel
    from pennyjax._src.api import _dtype  # pylint: disable=import-outside-toplevel
...
def _capture_vjp(func, params, cotangents, *, argnums=None, method=None, h=None):
    import pennyjax as jax  # pylint: disable=import-outside-toplevel
    from pennyjax.tree_util import tree_leaves, tree_unflatten  # pylint: disable=import-outside-toplevel
