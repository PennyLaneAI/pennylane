...
def decomp_inspector(  # pylint: disable=too-many-arguments
    ...
    **Examples**
    ...
    Full Expansion Gates: {CNOT: 72, GlobalPhase: 95, MidMeasure: 4, RX: 35, RY: 24, RZ: 80}
    Weighted Cost: 215.0
    ...
    .. details::
        ...
        Full Expansion Gates: {CNOT: 96, GlobalPhase: 226, MidMeasure: 6, RX: 58, RY: 54, RZ: 170}
        Weighted Cost: 384.0
