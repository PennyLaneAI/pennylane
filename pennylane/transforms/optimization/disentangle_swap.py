...
@transform
def disentangle_swap(tape: QuantumScript) -> tuple[QuantumScriptBatch, PostprocessingFn]:
    """Quantum transform to disentangle SWAP gates using relaxed peephole optimization
    taken from https://arxiv.org/pdf/2012.07711 table 6 (Equivalences for basis-states in 
    SWAP gate)
