...
def transpile(tape: QuantumTape, coupling_map, device=None) -> (Sequence[QuantumTape], Callable):
    ...
    Args:
        ...
        This data can be any format accepted by `nx.to_networkx_graph()`, currently including edge list, dict of dicts, dict of lists, NetworkX graph, 2D NumPy array, SciPy sparse matrix, or PyGraphviz graph
