...
def _stoch_pulse_grad(tape, argnum=None, num_samples=1, sampler_seed=None, shots=None):
    ...
    This transform implements the stochastic parameter-shift rule for pulse sequences, as introduced
    ...
    **Examples**
    ...
    .. code-block:: python
        ...
        qnode = qml.QNode(program, dev, interface="jax", diff_method=qml.gradients.stoch_pulse_grad)
    ...
    .. details::
        ...
        .. math::
            ...
            \ket{\psi_{j}(\boldsymbol{v}, x_\ell, \tau)} 
            &= U_{\boldsymbol{v}}(T, \tau) e^{-i x_\ell H_j}U_{\boldsymbol{v}}(\tau, 0)\ket{\psi_0}.
        ...
        **Examples**
        ...
        .. math::
            ...
            \ket{\psi_{j}((v_1, v_2), -\pi/4, \tau)} \\
            \ket{\psi_{j}((v_1, v_2), -\pi/4, \tau)}
            &= U_{(v_1, v_2)}(T, \tau) e^{-i \pi/4 H_j}U_{(v_1, v_2)}(\tau, 0)\ket{0}.
