...
def compute_vjp_new(dy, jac, num=None):
...
def vjp_new(tape, dy, gradient_fn, gradient_kwargs=None):
    ...
    **Example**
    ...
    def processing_fn(results, num=None):
        ...
        jac = fn(results)
        return compute_vjp_new(dy, jac, num=num)

    return gradient_tapes, processing_fn


def batch_vjp_new(tapes, dys, gradient_fn, reduction="append", gradient_kwargs=None):
    r"""Generate the gradient tapes and processing function required to compute
    ...
    **Example**
    ...
    for tape, dy in zip(tapes, dys):
        g_tapes, fn = vjp_new(tape, dy, gradient_fn, gradient_kwargs)
