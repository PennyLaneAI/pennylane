...
from pennylane.beta._device import Device
    ...
    * :meth:`~.expval`, :meth:`~.var`, :meth:`~.sample`: return expectation values,
    ...
    def execute(self, circuit, **kwargs):
        ...
        * :meth:`~.probability`
        ...
        if circuit.is_batched:
            # redirect entire execution to other method
            return self.batch_execute(circuit, **kwargs)

        else:
            return self.single_execute(circuit, **kwargs)

    def single_execute(self, circuit, **kwargs):
