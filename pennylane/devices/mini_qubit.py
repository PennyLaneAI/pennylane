...
"""
Contains the MiniQubit device, a minimal device that can be used for testing
and plugin developement purposes.
"""
...
class MiniQubit(Device):
    ...
    def preprocess(self, execution_config=DefaultExecutionConfig):
        ...
        program.add_transform(validate_device_wires, wires=self.wires, name="mini.qubit")
