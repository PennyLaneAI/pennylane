...
class DefaultQubit(QubitDevice):
    ...
    def __init__(self, wires, *, shots=None, custom_ops=None, cache=0, analytic=None):
        super().__init__(wires, shots, cache=cache, custom_ops=custom_ops, analytic=analytic)
