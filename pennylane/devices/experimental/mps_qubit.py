...
from ..mps.simulate import simulate
from ..mps.preprocess import preprocess, validate_and_expand_adjoint
from ..mps.adjoint_jacobian import adjoint_jacobian
...
class MPSQubit(Device):
    ...
    **Example:**
    ...
    def supports_derivatives(
        ...
        ``MPSQubit`` supports backpropagation derivatives with analytic results, as well as
