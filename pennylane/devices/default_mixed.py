...
class DefaultMixed(QubitDevice):
    ...
    def _generate_projector_diagonal(self, wire):
        """Computes the diagonal elements of the projector onto the subspace
        generated by the given wire being in state |0>. The projector is given
        by Id ⊗ |0><0| ⊗ Id, where |0><0| acts on `wire` and the left and
        right identity operators on the remaining wires.
        
        **Example**
        For 3 wires, the possible diagonals generated are:
        wire = 0  ->  [1, 1, 1, 1, 0, 0, 0, 0]
        wire = 1  ->  [1, 1, 0, 0, 1, 1, 0, 0]
        wire = 2  ->  [1, 0, 1, 0, 1, 0, 1, 0]
        """
