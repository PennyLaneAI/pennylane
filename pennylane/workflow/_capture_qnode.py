...
def custom_staging_rule(
    ...
    # In JAX 0.7+, use tracer.val to get the Var instead of trace.getvar()
    ...
    # In JAX 0.7+: use emit_eqn to create tracers and add equation
    out_tracers = jaxpr_trace.emit_eqn(
        tracers,
        new_shapes,
        qnode_prim,
        params,
