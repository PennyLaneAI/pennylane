...
def _estimate_impl(qnode, level, *args, **kwargs):
    ...
    # TODO: Should make use of tempdir to ensure cleanup
    estimation_fpath_prefix = "_quantum_est"
