...
from pennylane.operation import Observable, Operation, Tensor, Operator, InitialState
...
class Device(abc.ABC):
    ...
    def default_expand_fn(self, circuit, max_expansion=10):
        ...
        expand_state_prep = any(isinstance(op, InitialState) for op in circuit.operations[1:])

        if expand_state_prep:  # expand mid-circuit InitialState operations
