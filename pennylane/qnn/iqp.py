...
def _op_expval_indep(  # pylint: disable=too-many-arguments
    gates: list,
    n_qubits: int,
    params: list,
    ops: list,
...
def _op_expval_batch(  # pylint: disable=too-many-arguments
    gates: list,
    params: list,
    n_qubits: int,
    ops: list,
...
def iqp_expval(  # pylint: disable=too-many-arguments
    ops: list,
    weights: list[float],
