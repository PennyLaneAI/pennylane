...
def change_op_basis_subroutine_resource_rep(
    ...
    Args:
        compute (Operator | pennylane.decomposition.resources.CompressedResourceOp | Subroutine): the compute operator. May be a subroutine.
        target (Operator | pennylane.decomposition.resources.CompressedResourceOp | Subroutine): the target operator. May be a subroutine.
        uncompute (Operator | pennylane.decomposition.resources.CompressedResourceOp | Subroutine | None): the optional uncompute operator. May be a subroutine.
    Returns:
        pennylane.decomposition.CompressedResourceOp: a condensed representation of the :func:`~.ops.op_math.change_op_basis` involving a subroutine that can be
