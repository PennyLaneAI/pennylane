...
class HilbertSchmidt(Operation):
    ...
    def __init__(self, *params, u_circuit, v_circuit, v_wires, do_queue=True, id=None):
    ...
    @staticmethod
    def compute_decomposition(params, wires, n_wires, U, V):  # pylint: disable=arguments-differ,unused-argument
    ...
    def adjoint(self):
        adjoint_op = HilbertSchmidt(wires=self.wires)
