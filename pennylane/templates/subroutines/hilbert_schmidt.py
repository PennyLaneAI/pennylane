...
class HilbertSchmidt(Operation):
    ...
    **Reference**
    ...
    def compute_decomposition(
        ...
        # Unitary V conjugate
        decomp_ops.extend(qml.adjoint(op_v, lazy=False) for op_v in v_script.operations)
...
class LocalHilbertSchmidt(HilbertSchmidt):
    ...
    **Reference**
    ...
    def compute_decomposition(
        ...
        # Unitary V conjugate
        decomp_ops.extend(qml.adjoint(qml.apply, lazy=False)(op_v) for op_v in v_script.operations)
