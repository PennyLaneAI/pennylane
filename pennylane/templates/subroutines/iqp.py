...
class IQP(Operation):
    ...
    resource_keys = {"spin_sym", "gates", "n_qubits"}

    def __init__(
        self, wires, gates, params, spin_sym=None, id=None
...
def _instantaneous_quantum_polynomial_resources(spin_sym, gates, n_qubits):
