...
class QROM(Operation):
    ...
    **Example**
    ...
    .. details::
        ...
        The first :math:`c-1` work wires are asigned to the :class:`~.Select` block where :math:`l` is the length of
        the bitstrings and :math:`c` is the number of control wires in the operator.
