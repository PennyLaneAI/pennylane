...
def UCCSD(weights, wires, ph=None, pphh=None, init_state=None):
    ...
    Args:
        weights (array): length ``len(ph)+len(pphh)`` vector containing the parameters
            ...
            These parameters are precisely the coupled-cluster amplitudes that need to be optimized
            for each configuration generated by the excitation operator.
    ...
    .. UsageDetails::
        ...
        .. code-block:: python
            ...
            import pennylane as qml
            from pennylane.templates import UCCSDUnitary
