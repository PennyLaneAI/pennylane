    ...
    * :math:`(L, 2n)` else.
    ...
    def compute_decomposition(
        ...
        **Example**
        ...
        [RX(1.0, wires=['a']), RX(2.0, wires=['b']), MultiRZ(0.100..., wires=['a', 'b']), RY(-0.3000..., wires=['a']), RY(1.2999..., wires=['b']), RX(1.0, wires=['a']), RX(2.0, wires=['b']), MultiRZ(0.899..., wires=['a', 'b']), RY(-0.2000..., wires=['a']), RY(-2.1000..., wires=['a']), RX(1.0, wires=['a']), RX(2.0, wires=['b'])]
        """
        wires = Wires(wires)
