...
def make_plxpr(
    ...
    **Example**
    ...
    .. details::
        ...
        The ``autograph`` argument is ``True`` by default, converting Pythonic control flow to
        PennyLane supported control flow. This requires the diastatic-malt package, a standalone
