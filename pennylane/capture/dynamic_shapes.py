...
def register_custom_staging_rule(
    ...
    def custom_partial_eval_rule(trace, source_info, *tracers, **params):
        ...
        from jax._src.interpreters.partial_eval import TracingEqn, JaxprEqnContext
        from jax._src import xla_metadata_lib, compute_on
    ...
    with warnings.catch_warnings():
        warnings.filterwarnings("ignore", category=DeprecationWarning, message=".*custom_staging_rules.*")
