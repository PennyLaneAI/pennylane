...
def lie_closure(
    ...
    *,  # force non-positional kwargs of the following
    ...
    .. warning:: :func:`~lie_closure` has moved to the :doc:`code/liealg` module and can be called from there via ``qml.liealg.lie_closure`` or from the top level via ``qml.lie_closure``.
