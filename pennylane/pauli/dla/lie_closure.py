...
def lie_closure(
    ...
    .. see-also:: :func:`~.structure_constants`, :func:`~.center`, `Demo: Introduction to Dynamical Lie Algebras for quantum practitioners <https://pennylane.ai/qml/demos/tutorial_liealgebra/>`__
