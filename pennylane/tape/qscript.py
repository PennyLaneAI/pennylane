...
class QuantumScript:
    ...
    **Example:**
    ...
    def data(self) -> list[TensorLike]:
        """Alias to :meth:`~.get_parameters` for backwards compatibility with operations."""
    ...
    def trainable_params(self) -> list[int]:
        ...
        The number of trainable parameters changes the default output size of
        method :meth:`~.get_parameters()`.
