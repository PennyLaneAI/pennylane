...
class QuantumTape(AnnotatedQueue):
    ...
    **Example**
    ...
    def _update_circuit_info(self):
        ...
        self.is_sampled = any(m.return_type in (Sample, Counts, AllCounts, Shadow) for m in self.measurements)
        self.all_sampled = all(m.return_type in (Sample, Counts, AllCounts, Shadow) for m in self.measurements)
