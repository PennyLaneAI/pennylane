...
class TestExpval:
    ...
    def test_identity_expectation(self, device_name, tol):
    ...
    def test_pauliz_expectation(self, device_name, tol):
    ...
    def test_paulix_expectation(self, device_name, tol):
    ...
    def test_pauliy_expectation(self, device_name, tol):
    ...
    def test_hadamard_expectation(self, device_name, tol):
    ...
    def test_hermitian_expectation(self, device_name, tol):
    ...
    def test_multi_mode_hermitian_expectation(self, device_name, tol):
...
class TestTensorExpval:
    ...
    def test_paulix_pauliy(self, device_name, tol):
        """Test that a tensor product involving PauliX and PauliY works correctly"""
        dev = qml.device(device_name, wires=3)
        if not dev._capabilities['model'] == 'qubit':
            pytest.skip("Skipped for devices with no support for tensor observables.")
        if not dev._capabilities['model'] == 'qubit':
            pytest.skip("Skipped for devices not based on qubit model.")
        if not dev.analytic:
            pytest.skip("Skipped for devices with no analtyic support.")
    ...
    def test_pauliz_hadamard(self, device_name, tol):
    ...
    def test_hermitian(self, device_name, tol):
...
class TestSample:
    ...
    def test_sample_values(self, device_name, tol):
    ...
    def test_sample_values_hermitian(self, device_name, tol):
        """Tests if the samples of a Hermitian observable returned by sample have
        the correct values
        """
        dev = qml.device(device_name, wires=1, shots=1000)
        if not dev._capabilities['model'] == 'qubit':
            pytest.skip("Skipped for devices not based on qubit model.")
    ...
    def test_sample_values_hermitian_multi_qubit(self, device_name, tol):
...
class TestVar:
    ...
    def test_var(self, device_name, tol):
        """Tests if the samples returned by sample have
        the correct values
        """
    ...
    def test_var_hermitian(self, device_name, tol):
        """Tests if the samples of a Hermitian observable returned by sample have
        the correct values
        """
        dev = qml.device(device_name, wires=2, shots=8192)
        ...
        def circuit():
            qml.RX(phi, wires=[0])
            qml.RX(theta, wires=[0])
            return qml.sample(qml.Hermitian(H, wires=0))
