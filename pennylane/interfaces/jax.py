...
def jax_jvp_execute(tapes: Batch, execute_fn: ExecuteFn, jpc, device=None, differentiable=None):
...
def jax_vjp_execute(tapes: Batch, execute_fn: ExecuteFn, jpc, device=None, differentiable=None):
