...
INITALL_KWARGS_SHAPES = [
    ...
    (
        qml.init.custom_entangler_layers_normal,
        {"n_layers": 2, "n_wires": 3, "pattern": "all_to_all"},
        [(2, 3), (2, 3)],
    ),
    (
        qml.init.custom_entangler_layers_uniform,
        {"n_layers": 2, "n_wires": 3, "pattern": [[0, 1]]},
        [(2, 3), (2, 1)],
    ),
]
