...
class TestInit:
    ...
    def test_particle_conserving_u1_init(self):
        """Test the shape of the paramater arrays generated by the functions
        'particle_conserving_u1_uniform' and 'particle_conserving_u1_normal'."""
