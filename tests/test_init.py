...
INIT_KWARGS_SHAPES = [(qml.init.random_layers_normal, rnd_rpt_nrml1, (repeat, n_rotations)),
                      ...
                      (qml.init.simplified_two_design_initial_block_uniform, {'n_wires': 1, 'low': 0, 'high': 1}, (1,)),
                      (qml.init.simplified_two_design_initial_block_uniform, {'n_wires': 3, 'low': 0, 'high': 1}, (3,)),
                      (qml.init.simplified_two_design_initial_block_normal, {'n_wires': 1, 'mean': 0, 'std': 1}, (1,)),
                      (qml.init.simplified_two_design_initial_block_normal, {'n_wires': 3, 'mean': 0, 'std': 1}, (3,)),
