...
class TestSampleBasisStates:
    ...
    def test_raises_deprecation_warning(self, mock_qubit_device, monkeypatch):
        ...
        with pytest.warns(DeprecationWarning, match="The number of shots has to be explicitly set on the device"):
...
class TestShotList:
    ...
    shot_data = [
        [[1, 2, 3, 10], [(1, 1), (2, 1), (3, 1), (10, 1)], [(2,), (2,2), (2,3), (2,10)], 16],
        [[1, 2, 2, 2, 10, 1, 1, 5, 1, 1, 1], [(1, 1), (2, 3), (10, 1), (1, 2), (5, 1), (1, 3)],
                [(2,), (2,2), (2,2),(2,2),(2,10), (2,), (2,), (2,5), (2,), (2,), (2,)], 27],
        [[10, 10, 10], [(10, 3)], [(2,10), (2,10), (2,10)], 30],
        [[(10, 3)], [(10, 3)], [(2,10),(2,10),(2,10)], 30],
    ]
