...
"""Unit tests for the BaseQuantumTape"""
import pytest
import numpy as np

import pennylane as qml
from pennylane.tape import BaseQuantumTape, TapeCircuitGraph
...
class TestExpand:
    ...
    def test_nested_tape(self):
        ...
        with BaseQuantumTape() as tape1:
            with BaseQuantumTape() as tape2:
