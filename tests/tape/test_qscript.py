...
class TestUpdate:
    ...
    def test_get_operation(self):
        ...
        qml.assert_equal(op_0, ops[0]) and op_id_0 == 0 and p_id_0 == 0

        op_1, op_id_1, p_id_1 = qs.get_operation(1)
        qml.assert_equal(op_1, ops[1]) and op_id_1 == 1 and p_id_1 == 0

        op_2, op_id_2, p_id_2 = qs.get_operation(2)
        qml.assert_equal(op_2, ops[1]) and op_id_2 == 1 and p_id_2 == 1

        op_3, op_id_3, p_id_3 = qs.get_operation(3)
        qml.assert_equal(op_3, ops[1]) and op_id_3 == 1 and p_id_3 == 2

        op_4, op_id_4, p_id_4 = qs.get_operation(4)
        qml.assert_equal(op_4, ops[3]) and op_id_4 == 3 and p_id_4 == 0

        op_5, op_id_5, p_id_5 = qs.get_operation(5)
        qml.assert_equal(op_5, ops[4]) and op_id_5 == 4 and p_id_5 == 0

        op_6, op_id_6, p_id_6 = qs.get_operation(6)
        qml.assert_equal(op_6, ops[4]) and op_id_6 == 4 and p_id_6 == 1
