...
class TestScriptCopying:
    ...
    def test_copy_update_operations(self):
        ...
        assert (
            new_tape.measurements == new_tape2.measurements == tape.measurements == [qp.counts()]
        )
...
class TestDiagonalizingGates:
    ...
    def test_diagonalizing_gates(self):
        ...
        assert (
            ...
            == qp.X(0).diagonalizing_gates() + qp.Y(1).diagonalizing_gates()
        )
    ...
    def test_non_commuting_obs(self):
        ...
        assert (
            qs.diagonalizing_gates
            == qp.X(0).diagonalizing_gates() + qp.Y(0).diagonalizing_gates()
        )
