...
from pennylane.gradients.spsa import _rademacher_sampler
...
class TestRademacherSampler:
    ...
    def test_convergence_single_par(self, num_directions, tol):
        ...
        tapes, fn = spsa_gradient(tape, num_directions=num_directions)
...
class TestSpsaGradient:
    ...
    def test_no_trainable_params_tape(self):
        ...
        with pytest.warns(UserWarning, match="gradient of a tape with no trainable parameters"):
            g_tapes, post_processing = spsa_gradient(tape)
    ...
    def test_no_trainable_params_qnode_autograd(self):
        ...
        with pytest.warns(UserWarning, match="gradient of a QNode with no trainable parameters"):
            res = spsa_gradient(circuit)(weights)
    ...
    def test_all_zero_diff_methods(self):
        ...
        result = spsa_gradient(circuit)(params)
        assert np.allclose(result, np.zeros((4, 3)), atol=0, rtol=0)

        tapes, _ = spsa_gradient(circuit.tape)
        assert tapes == []
    ...
    def test_y0(self, mocker):
        ...
        n = 13
        tapes, fn = spsa_gradient(tape, strategy="forward", approx_order=1, num_directions=n)
    ...
    def test_y0_provided(self):
        ...
        f0 = dev.execute(tape)
        n = 9
        tapes, fn = spsa_gradient(tape, strategy="forward", approx_order=1, num_directions=n, f0=f0)
    ...
    def test_independent_parameters(self):
        ...
        n1 = 5
        tapes, fn = spsa_gradient(tape1, approx_order=1, strategy="forward", num_directions=n1)
        ...
        n2 = 11
        tapes, fn = spsa_gradient(tape2, num_directions=n2)
    ...
    def test_output_shape_matches_qnode(self):
        ...
        transform = [qml.math.shape(spsa_gradient(c)(x)) for c in circuits]
