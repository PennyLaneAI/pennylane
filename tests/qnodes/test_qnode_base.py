...
class TestQNodeCircuitHashIntegration:
    ...
    def test_evaluate_circuit_hash_symbolic_bound_arguments_do_not_matter(self, a, b, x, y):
        """Tests that the circuit hash of identical circuits are equal"""
        dev = qml.device("default.qubit", wires=2)
    ...
    def test_evaluate_circuit_hash_numeric_tensor_return(self):
        """Tests that the circuit hash of identical circuits are equal"""
        dev = qml.device("default.qubit", wires=2)
    ...
    def test_evaluate_circuit_hash_tensor_return(self, x, y):
        """Tests that the circuit hash of identical circuits are equal"""
        dev = qml.device("default.qubit", wires=3)
