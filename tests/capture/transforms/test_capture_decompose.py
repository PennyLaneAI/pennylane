...
class TestDecomposeInterpreter:
    ...
    def test_decompose_simple(self):
        ...
        assert_eqn_matches_op(jaxpr.eqns[1], qp.RY)
    ...
    def test_subroutine(self):
        ...
        for eqn in [eqn1, eqn2]:
            ...
            j = eqn.params["jaxpr"]
            assert_eqn_matches_op(j.eqns[-3], qp.CNOT)
            assert_eqn_matches_op(j.eqns[-2], qp.RX)
            assert_eqn_matches_op(j.eqns[-1], qp.CNOT)
    ...
    def test_qnode_higher_order_primitive(self):
        ...
        assert_eqn_matches_op(qfunc_jaxpr.eqns[1], qp.RY)
...
def test_decompose_plxpr_to_plxpr():
    ...
    assert_eqn_matches_op(transformed_jaxpr.eqns[1], qp.RY)
