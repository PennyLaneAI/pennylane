...
class TestIntegrationCircuit:
    ...
    def test_integration_qubit_nondiffable(self, template1, diffable1, nondiffable1,
        ...
        diffable1 = {k: to_var(v) for k, v in diffable1.items()}
        diffable2 = {k: to_var(v) for k, v in diffable2.items()}
    ...
    #
    # @pytest.mark.parametrize("template1, inpts1, hyperp1", CV_DIFFABLE_NONDIFFABLE)
    # @pytest.mark.parametrize("template2, inpts2, hyperp2", CV_DIFFABLE_NONDIFFABLE)
    # @pytest.mark.parametrize("interface, to_var", INTERFACES)
...
#     @pytest.mark.parametrize("template, inpts, hyperparams", QUBIT_DIFFABLE_NONDIFFABLE)
#     @pytest.mark.parametrize("interface, to_var", INTERFACES)
