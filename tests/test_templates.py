...
standard_layer_inputs = "template, weights"
standard_layers = [(StronglyEntanglingLayers, [[[1.50820225, 4.24049172, 5.58068076],
                                                [3.72927363, 5.4538957, 1.21793098]],
                                               [[5.25049813, 1.11059904, 0.52967773],
                                                  [4.9789569, 1.42562158, 2.49977512]]]),
                   (RandomLayers, [[0.53479316, 5.88709314], [2.21352321, 4.28468607]])]
standard_emb_inputs = "template, features, weights"
standard_embeddings = [(AmplitudeEmbedding, [1/2, 1/2, 1/2, 1/2], []),
                       (BasisEmbedding, [1, 0], []),
                       (AngleEmbedding, [1., 2.], []),
                       (DisplacementEmbedding, [1., 2.], []),
...
class TestCircuitIntegration:
    ...
    @pytest.mark.parametrize(standard_layer_inputs, standard_layers)
    def test_circuit_integration_standard_qubit_layers(self, template, weights):
    ...
    @pytest.mark.parametrize(standard_emb_inputs, standard_embeddings)
    def test_circuit_integration_standard_qubit_embedding(self, template, features, weights):
    ...
    @pytest.mark.parametrize(standard_emb_inputs, standard_embeddings)
    def test_circuit_integration_standard_cv_embedding(self, gaussian_device_2_wires, template, features, weights):
...
class TestInterfaceIntegration:
    ...
    @pytest.mark.parametrize(standard_layer_inputs, standard_layers)
    def test_interface_integration_standard_qubit_layers_torch(self, template, weights):
    ...
    @pytest.mark.parametrize(standard_layer_inputs, standard_layers)
    def test_interface_integration_standard_qubit_layers_tf(self, template, weights):
        """Checks that pennylane.templates.layers.StronglyEntanglingLayers() can be used with the
    ...
    @pytest.mark.parametrize(standard_emb_inputs, standard_embeddings)
    def test_interface_integration_standard_embedding_torch(self, template, features, weights):
    ...
    @pytest.mark.parametrize(standard_emb_inputs, standard_embeddings)
    def test_interface_integration_standard_cv_embedding_torch(self, gaussian_device_2_wires,
