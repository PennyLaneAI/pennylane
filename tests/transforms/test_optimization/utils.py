...
def _compute_matrix_from_ops_one_qubit(ops):
...
def _compute_matrix_from_ops_two_qubit(ops, wire_order):
    """Given a list of single-qubit operations, construct its matrix representation."""
...
def _check_matrix_equivalence(matrix_expected, matrix_obtained):
