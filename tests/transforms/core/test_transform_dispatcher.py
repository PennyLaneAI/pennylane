...
class TestTransformDispatcher:  # pylint: disable=too-many-public-methods
    ...
    def test_integration_dispatcher_with_valid_transform(self, valid_transform):
        ...
        assert isinstance(qnode_transformed.transform_program, qml.TransformProgram)
        assert isinstance(
    ...
    def test_integration_dispatcher_with_valid_transform_decorator_partial(self, valid_transform):
        ...
        assert isinstance(qnode_circuit.transform_program, qml.TransformProgram)
        assert isinstance(
    ...
    def test_custom_qnode_transform(self, valid_transform):
        ...
        assert isinstance(qnode1.transform_program, qml.TransformProgram)
        assert isinstance(
        ...
        assert isinstance(qnode2.transform_program, qml.TransformProgram)
        assert isinstance(
    ...
    def test_device_transform(self, valid_transform):
        ...
        assert isinstance(program, qml.TransformProgram)
        assert isinstance(new_program, qml.TransformProgram)
