...
class TestAddNoise:
    """Tests for the add_noise function"""
    ...
    def test_multiwire_noisy_op(self):
        ...
        r = add_noise(self.tape, qml.QubitChannel, [])(self.tape)
        # print(add_noise)
...
#             add_noise(self.tape, qml.AmplitudeDamping, 0.4, position="ABC")
#
...
#             add_noise(self.tape, qml.PauliX, 0.4)
#
#     def test_start(self):
#         """Test if the expected tape is returned when the start position is requested"""
#         tape = add_noise(self.tape, qml.AmplitudeDamping, 0.4, position="start")
#
...
#         tape = add_noise(self.tape, qml.PhaseDamping, 0.4, position="all")
#
#         with QuantumTape() as tape_exp:
#             qml.RX(0.9, wires=0)
...
#         tape = add_noise(self.tape_with_prep, qml.AmplitudeDamping, 0.4, position="start")
#
#         with QuantumTape() as tape_exp:
#             qml.QubitStateVector([1, 0], wires=0)
#             qml.AmplitudeDamping(0.4, wires=0)
...
#         that has state preparation"""
#         tape = add_noise(self.tape_with_prep, qml.PhaseDamping, 0.4, position="all")
#
#         with QuantumTape() as tape_exp:
#             qml.QubitStateVector([1, 0], wires=0)
#             qml.RX(0.9, wires=0)
...
#             add_noise(tape, qml.AmplitudeDamping, 0.4)
#
#
