...
"""Unit tests for entanglement entropies."""
...
class TestEntanglementEntropies:
    """Tests for the entanglement entropies."""
    ...
    @pytest.mark.parametrize("params", np.linspace(0, 2 * np.pi, 4)[1:])
    def test_qnode_transform_grad(self, device, params):
    ...
    @pytest.mark.parametrize("device", ["default.qubit", "default.mixed"])
    @pytest.mark.parametrize("params", np.linspace(0, 2 * np.pi, 4)[1:])
    def test_qnode_transform_grad_jax(self, device, params):
        import jax
    ...
    @pytest.mark.parametrize("device", ["default.qubit", "default.mixed"])
    @pytest.mark.parametrize("params", np.linspace(0, 2 * np.pi, 4)[1:])
    def test_qnode_transform_grad_jax_jit(self, device, params):
        import jax
    ...
    @pytest.mark.parametrize("device", ["default.qubit", "default.mixed"])
    @pytest.mark.parametrize("params", np.linspace(0, 2 * np.pi, 4)[1:])
    def test_qnode_transform_grad_torch(self, device, params):
    ...
    @pytest.mark.parametrize("device", ["default.qubit", "default.mixed"])
    @pytest.mark.parametrize("params", np.linspace(0, 2 * np.pi, 4)[1:])
    def test_qnode_transform_grad_tf(self, device, params):
