...
class TestPurity:
    ...
    @pytest.mark.parametrize("param", parameters)
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    def test_IsingXX_qnode_purity_grad(self, device, param, wires, is_partial):
        """Tests purity for a qnode"""
    ...
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    @pytest.mark.parametrize("param", probs)
    def test_bit_flip_qnode_purity_grad(self, device, wires, param, is_partial):
    ...
    @pytest.mark.parametrize("param", parameters)
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    def test_IsingXX_qnode_purity_grad_jax(self, device, param, wires, is_partial):
    ...
    @pytest.mark.parametrize("param", parameters)
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    def test_IsingXX_qnode_purity_grad_jax_jit(self, device, param, wires, is_partial):
        """Test purity for a QNode gradient with Jax."""
    ...
    @pytest.mark.parametrize("param", parameters)
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    def test_IsingXX_qnode_purity_grad_torch(self, device, param, wires, is_partial):
    ...
    @pytest.mark.parametrize("param", parameters)
    @pytest.mark.parametrize("wires,is_partial", wires_list)
    def test_IsingXX_qnode_purity_grad_tf(self, device, param, wires, is_partial):
