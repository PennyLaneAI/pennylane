...
def circuit_measure_multiple_with_max_twice():
    """A fixture of a circuit that measures wire 0 twice."""
    return qml.expval(qml.PauliX(wires=0)), qml.probs(wires=[0,1,2]), qml.var(qml.PauliX(wires=[1]) @ qml.PauliZ([2]))
...
class TestCircuitGraph:
    ...
    @pytest.mark.parametrize("circ, expected", [(circuit_measure_max_once, 1),
