...
interface_and_diff_method = [["auto"] + inner_list for inner_list in diff_method_list] + [
    ["jax"] + inner_list for inner_list in diff_method_list
]
...
class TestQNode:
    ...
    def test_execution_with_interface(self, diff_method, grad_on_execution, interface):
    ...
    def test_matrix_parameter(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_differentiable_expand(self, diff_method, grad_on_execution, interface, tol):
...
class TestVectorValuedQNode:
    ...
    def test_diff_expval_expval(self, diff_method, grad_on_execution, interface, mocker, tol):
    ...
    def test_jacobian_no_evaluate(self, diff_method, grad_on_execution, interface, mocker, tol):
    ...
    def test_diff_multi_probs(self, diff_method, grad_on_execution, interface, tol):
        """Tests correct output shape and evaluation for a tape
    ...
    def test_diff_expval_probs(self, diff_method, grad_on_execution, interface, tol):
        """Tests correct output shape and evaluation for a tape
    ...
    def test_diff_expval_probs_sub_argnums(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_diff_var_probs(self, diff_method, grad_on_execution, interface, tol):
        """Tests correct output shape and evaluation for a tape
...
class TestQubitIntegration:
    ...
    def test_sampling(self, diff_method, grad_on_execution):
...
class TestQubitIntegrationHigherOrder:
    ...
    def test_second_derivative(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_hessian(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_hessian_vector_valued(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_hessian_vector_valued_postprocessing(
        self, diff_method, interface, grad_on_execution, tol
    ):
    ...
    def test_state(self, diff_method, grad_on_execution, interface, tol):
    ...
    def test_projector(self, diff_method, grad_on_execution, interface, tol):
...
class TestTapeExpansion:
    ...
    def test_gradient_expansion_trainable_only(
        self, diff_method, grad_on_execution, max_diff, interface, mocker
    ):
    ...
    def test_hamiltonian_expansion_analytic(
        self, diff_method, grad_on_execution, max_diff, interface, mocker, tol
    ):
...
class TestReturn:  # pylint:disable=too-many-public-methods
    ...
    def test_grad_single_measurement_multiple_param(
        self, diff_method, grad_on_execution, shots, interface
    ):
    ...
    def test_jacobian_single_measurement_param_probs(
        self, diff_method, grad_on_execution, jacobian, shots, interface
    ):
    ...
    def test_hessian_expval_multiple_params(self, diff_method, grad_on_execution, shots, interface):
    ...
    def test_hessian_var_multiple_params(self, diff_method, grad_on_execution, shots, interface):
        """The hessian of single a measurement with multiple params return a tuple of arrays."""
        if diff_method == "adjoint":
            pytest.skip("Test does not supports adjoint because second order diff.")
        elif diff_method == "hadamard":
