...
class TestTensorFlowExecuteIntegration:
    ...
    def test_scalar_jacobian(self, execute_kwargs, tol):
        ...
        res = t.jacobian(res, a, experimental_use_pfor=False)
        assert res.shape == (1,)
    ...
    def test_jacobian(self, execute_kwargs, tol):
        ...
        (agrad, bgrad) = t.jacobian(res, [a, b], experimental_use_pfor=False)
    ...
    def test_reusing_quantum_tape(self, execute_kwargs, tol):
        ...
        jac = t.jacobian(res, [a, b], experimental_use_pfor=False)
        ...
        jac2 = t.jacobian(res2, [a, b], experimental_use_pfor=False)
        expected = [
    ...
    def test_classical_processing(self, execute_kwargs, tol):
        ...
        res = t.jacobian(res, [a, b, c], experimental_use_pfor=False)
    ...
    def test_no_trainable_parameters(self, execute_kwargs, tol):
        ...
        res = t.jacobian(res, b, experimental_use_pfor=False)
        assert res is None
    ...
    def test_probability_differentiation(self, execute_kwargs, tol):
        ...
        res = t.jacobian(res, [x, y], experimental_use_pfor=False)
        expected = np.array(
            [
                [
...
class TestHigherOrderDerivatives:
    ...
    def test_parameter_shift_hessian(self, params, tol):
        ...
        hess = t2.jacobian(grad, params, experimental_use_pfor=False)
        expected = np.array(
            [
...
class TestHamiltonianWorkflows:
    ...
    def test_multiple_hamiltonians_not_trainable(self, cost_fn, execute_kwargs, tol):
        ...
        res = tape.jacobian(res, [weights, coeffs1, coeffs2], experimental_use_pfor=False)
