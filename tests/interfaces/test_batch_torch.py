...
class TestCaching:
    ...
    def test_caching_param_shift_hessian(self, num_params, tol):
        ...
        def cost(x, cache):
            ...
            return execute([tape], dev, gradient_fn=param_shift, cache=cache, interface="torch", max_diff=2)[0]
...
class TestHigherOrderDerivatives:
    ...
    def test_parameter_shift_hessian(self, torch_device, params, tol):
        ...
        def cost_fn(x):
            ...
            result = execute([tape1, tape2], dev, gradient_fn=param_shift, interface="torch", max_diff=2)
    ...
    def test_hessian_vector_valued(self, torch_device, tol):
        ...
        def circuit(x):
            ...
            return torch.stack(execute([tape], dev, gradient_fn=param_shift, interface="torch", max_diff=2))
