...
class TestDecompositionGraph:
    ...
    def test_get_decomp_rule(self, _):
        ...
        assert graph._get_decompositions(resource_rep(qml.Hadamard)) == decompositions["Hadamard"]
        ...
        assert graph._get_decompositions(resource_rep(qml.Hadamard)) == [custom_hadamard]
        ...
        assert graph._get_decompositions(resource_rep(qml.Hadamard)) == exp_dec
...
class TestSymbolicDecompositions:
    """Tests that the decomposition graph can handle symbolic decompositions."""
    ...
    def test_get_controlled_decomp_rule(self, _):
        """Tests getting decomposition rules of a controlled operator."""
