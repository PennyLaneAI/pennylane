        ...
        assert actual_resources == Resources(
            {
                ...
                _ctrl_abstract(qp.RZ, Wire[2], Wire[0]): 1,
        ...
        assert actual_resources == Resources(
            {
                ...
                _ctrl_abstract(qp.RX, Wire[2], Wire[0]): 1,
                _ctrl_abstract(qp.Rot, Wire[2], Wire[0]): 1,
                _ctrl_abstract(qp.RZ, Wire[3], Wire[0]): 1,
                qp.decomposition.controlled_resource_rep(
                    qp.MultiRZ,
                    {"num_wires": 6},
                    num_control_wires=2,
                ...
                abstractify(qp.CCZ): 1,
                _ctrl_abstract(qp.Z, Wire[3], Wire[0]): 1,
            }
        )
        ...
        assert actual_resources == Resources(
            {
                ...
                _ctrl_abstract(qp.RX, Wire[3], Wire[0]): 1,
                _ctrl_abstract(qp.Rot, Wire[3], Wire[0]): 1,
                _ctrl_abstract(qp.RZ, Wire[4], Wire[0]): 1,
                qp.decomposition.controlled_resource_rep(
                    qp.MultiRZ,
                    {"num_wires": 6},
                    num_control_wires=3,
                ...
                _ctrl_abstract(qp.Z, Wire[3], Wire[0]): 1,
                _ctrl_abstract(qp.Z, Wire[4], Wire[0]): 1,
            }
        )
