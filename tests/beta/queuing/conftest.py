...
def import_beta():
    """Import the beta version of queuing related modules."""
    sys.modules["pennylane.operation"] = importlib.import_module('pennylane.beta.queuing.operation')
    sys.modules["pennylane.measure"] = importlib.import_module('pennylane.beta.queuing.measure')
