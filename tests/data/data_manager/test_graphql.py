...
class TestGetGraphql:
    ...
    def test_return_json(self):
        ...
        valid query and url."""
        response = pennylane.data.data_manager.graphql.get_graphql(GRAPHQL_URL, self.query)
    ...
    def test_bad_url(self):
        ...
        with pytest.raises(requests.exceptions.ConnectionError):
            pennylane.data.data_manager.graphql.get_graphql("https://bad/url/graphql", self.query)
    ...
    def test_bad_query(self):
        ...
        with pytest.raises(requests.exceptions.HTTPError):
            pennylane.data.data_manager.graphql.get_graphql(GRAPHQL_URL, bad_query)
