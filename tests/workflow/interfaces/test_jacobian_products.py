...
class TestBasics:
    ...
    def test_device_jacobians_repr(self):
        ...
        expected = (
            ...
            r" gradient_method='adjoint', gradient_keyword_arguments=mappingproxy({}),"
            r" device_options=mappingproxy({}), interface=<Interface.NUMPY: 'numpy'>, derivative_order=1,"
    ...
    def test_device_jacobian_products_repr(self):
        ...
        expected = (
            ...
            r" ExecutionConfig(grad_on_execution=None, use_device_gradient=None,"
            r" use_device_jacobian_product=None,"
            r" gradient_method='adjoint', gradient_keyword_arguments=mappingproxy({}), device_options=mappingproxy({}),"
