...
class TestQSVTBasics:
    ...
    @pytest.mark.jax
    @pytest.mark.pl2do(reason="capture tests will fail until QSVT is migrated to Operator2")
...
class TestQSVTMatrix:
    """Tests the matrix of qsvt is correct."""
