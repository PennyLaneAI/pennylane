...
class TestGQSP:
    ...
    def test_queueing(self):
        ...
        with qp.queuing.AnnotatedQueue() as q:
            qp.GQSP(qp.Z(1), np.ones([3, 3]), control=0)
    ...
    def test_gqsp_jax(self):
        ...
        expected_output = jnp.array(qp.matrix(circuit, wire_order=[0, 1])(angles))
        generated_output = qp.matrix(circuit, wire_order=[0, 1])(jnp.array(angles))
    ...
    def test_gqsp_torch(self):
        ...
        expected_output = torch.tensor(qp.matrix(circuit, wire_order=[0, 1])(angles))
        generated_output = qp.matrix(circuit, wire_order=[0, 1])(torch.tensor(angles))
