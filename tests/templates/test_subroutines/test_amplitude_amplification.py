...
class TestInitialization:
    ...
    def test_error_none_wire(self, fixed_point, aux_wire, raise_error):
        ...
        if raise_error:
            ...
            with pytest.raises(
                ...
                qml.AmplitudeAmplification(U, O, iters = 3, fixed_point = fixed_point, aux_wire = aux_wire)
    ...
    def test_error_wrong_wires(self, U, O, raise_error):
        ...
        if raise_error:
            ...
            with pytest.raises(
                    TypeError, match="U and O must act on the same wires."
            ):
    ...
    def test_error_wrong_wire(self, wires, fixed_point, aux_wire, raise_error):
        ...
        if raise_error:
            ...
            with pytest.raises(
                    TypeError, match="aux_wire must be different from the wires of U."
            ):
                qml.AmplitudeAmplification(U, O, iters=3, fixed_point=fixed_point, aux_wire=aux_wire)
