...
class TestApplyChannelMethodChoice:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (qml.PauliError("X", jnp.array(0.5), wires=0), "_apply_channel", 2),
            (qml.PauliError("XXX", jnp.array(0.5), wires=[0, 1, 2]), "_apply_channel", 4),
            (
                qml.PauliError("X" * 8, jnp.array(0.5), wires=list(range(8))),
