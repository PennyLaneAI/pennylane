...
class TestSetShots:
    ...
    def test_no_change(self):
        ...
        batch, post_fn = qml.devices.preprocess.set_shots(tape, 10)
        ...
        assert post_fn == qml.devices.preprocess.null_postprocessing
    ...
    def test_changes_shots(self):
        ...
        batch, post_fn = qml.devices.preprocess.set_shots(tape, 20)
        new_tape = batch[0]
    ...
    def test_none_to_int(self):
        ...
        batch, _ = qml.devices.preprocess.set_shots(tape, 100)
    ...
    def test_int_to_none(self):
        ...
        batch, _ = qml.devices.preprocess.set_shots(tape, None)
    ...
    def test_preserves_measurements_and_ops(self):
        ...
        batch, _ = qml.devices.preprocess.set_shots(tape, 10)
        new_tape = batch[0]
    ...
    def test_returns_tuple(self):
        ...
        result = qml.devices.preprocess.set_shots(tape, 2)
    ...
    def test_error_finite_shots_with_backprop(self):
        ...
        @partial(qml.devices.preprocess.set_shots, shots=1000)
        @qml.qnode(dev)
        def circuit(x):
            qml.RX(x, wires=0)
            qml.RY(x, wires=1)
