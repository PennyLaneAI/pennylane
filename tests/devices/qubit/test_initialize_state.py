...
class TestInitializeState:
    ...
    def test_initialize_state_no_ops(self, ml_framework, dtype, num_wires):
    ...
    @pytest.mark.parametrize("ml_framework,dtype", SUPPORTED_INTERFACES_AND_TYPES)
    def test_initialize_state_with_prep(self, ml_framework, dtype):
    ...
    def test_too_many_wires_in_prep(self):
    ...
    def test_initialize_state_does_not_sort_wires(self, ml_framework):
    ...
    def test_wires_are_padded_in_calculation(self, ml_framework, wires):
    ...
    @pytest.mark.parametrize("ml_framework", SUPPORTED_INTERFACES)
    def test_basis_state_prep_can_be_used(self, ml_framework):
