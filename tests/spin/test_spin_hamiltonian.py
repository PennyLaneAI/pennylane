...
from pennylane.spin import (bose_hubbard, fermi_hubbard, heisenberg,
                            transverse_ising)
...
def test_hopping_error_bose_hubbard():
    r"""Test that an error is raised when the provided hopping shape is wrong for
    bose_hubbard Hamiltonian."""
    n_cells = [4, 4]
    lattice = "Square"
    with pytest.raises(
        ValueError,
        ...
        bose_hubbard(lattice=lattice, n_cells=n_cells, hopping=[1.0, 2.0], neighbour_order=1)


@pytest.mark.parametrize(
    # expected_ham was obtained from datasets
    ...
    [
        (
            ...
            -1.0,
            0.0,
            0.25000000000000006 * (X(0) @ X(1) @ X(2) @ X(3))
            + (0.25000000000000006 + 0j) * (X(0) @ X(1) @ Y(2) @ Y(3))
            + 0.48296291314453416 * (X(0) @ X(1) @ X(3))
            + -0.12940952255126037 * (X(0) @ X(1) @ Z(2) @ X(3))
            + (0.25000000000000006 + 0j) * (X(0) @ Y(1) @ X(2) @ Y(3))
            + (-0.25000000000000006 + 0j) * (X(0) @ Y(1) @ Y(2) @ X(3))
            + (-0.48296291314453416 + 0j) * (X(0) @ Y(1) @ Y(3))
            + (0.12940952255126037 + 0j) * (X(0) @ Y(1) @ Z(2) @ Y(3))
            + (-0.25000000000000006 + 0j) * (Y(0) @ X(1) @ X(2) @ Y(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ X(1) @ Y(2) @ X(3))
            + (0.48296291314453416 + 0j) * (Y(0) @ X(1) @ Y(3))
            + (-0.12940952255126037 + 0j) * (Y(0) @ X(1) @ Z(2) @ Y(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ Y(1) @ X(2) @ X(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ Y(1) @ Y(2) @ Y(3))
            + (0.48296291314453416 + 0j) * (Y(0) @ Y(1) @ X(3))
            + (-0.12940952255126037 + 0j) * (Y(0) @ Y(1) @ Z(2) @ X(3))
            + 0.48296291314453416 * (X(2) @ X(3) @ X(1))
            + (0.48296291314453416 + 0j) * (Y(2) @ Y(3) @ X(1))
            + 0.9330127018922193 * (X(1) @ X(3))
            + -0.24999999999999994 * (Z(2) @ X(3) @ X(1))
            + (-0.48296291314453416 + 0j) * (X(2) @ Y(3) @ Y(1))
            + (0.48296291314453416 + 0j) * (Y(2) @ X(3) @ Y(1))
            + (0.9330127018922193 + 0j) * (Y(1) @ Y(3))
            + (-0.24999999999999994 + 0j) * (Z(2) @ Y(3) @ Y(1))
            + -0.12940952255126037 * (Z(0) @ X(1) @ X(2) @ X(3))
            + (-0.12940952255126037 + 0j) * (Z(0) @ X(1) @ Y(2) @ Y(3))
            + -0.24999999999999994 * (Z(0) @ X(1) @ X(3))
            + 0.06698729810778066 * (Z(0) @ X(1) @ Z(2) @ X(3))
            + (0.12940952255126037 + 0j) * (Z(0) @ Y(1) @ X(2) @ Y(3))
            + (-0.12940952255126037 + 0j) * (Z(0) @ Y(1) @ Y(2) @ X(3))
            + (-0.24999999999999994 + 0j) * (Z(0) @ Y(1) @ Y(3))
            + (0.06698729810778066 + 0j) * (Z(0) @ Y(1) @ Z(2) @ Y(3)),
        ),
        (
            "chain",
            [4],
            -1.0,
            0.0,
            (0.25000000000000006 + 0j) * (X(0) @ X(1) @ X(2) @ X(3))
            + (0.25000000000000006 + 0j) * (X(0) @ X(1) @ Y(2) @ Y(3))
            + (0.48296291314453416 + 0j) * (X(3) @ X(0) @ X(1))
            + (-0.12940952255126037 + 0j) * (X(0) @ X(1) @ Z(2) @ X(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ X(1) @ Y(2) @ X(3))
            + (-0.25000000000000006 + 0j) * (Y(0) @ X(1) @ X(2) @ Y(3))
            + (0.48296291314453416 + 0j) * (Y(3) @ Y(0) @ X(1))
            + (-0.12940952255126037 + 0j) * (Y(0) @ X(1) @ Z(2) @ Y(3))
            + (-0.25000000000000006 + 0j) * (X(0) @ Y(1) @ Y(2) @ X(3))
            + (0.25000000000000006 + 0j) * (X(0) @ Y(1) @ X(2) @ Y(3))
            + (-0.48296291314453416 + 0j) * (Y(3) @ X(0) @ Y(1))
            + (0.12940952255126037 + 0j) * (X(0) @ Y(1) @ Z(2) @ Y(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ Y(1) @ X(2) @ X(3))
            + (0.25000000000000006 + 0j) * (Y(0) @ Y(1) @ Y(2) @ Y(3))
            + (0.48296291314453416 + 0j) * (X(3) @ Y(0) @ Y(1))
            + (-0.12940952255126037 + 0j) * (Y(0) @ Y(1) @ Z(2) @ X(3))
            + (0.48296291314453416 + 0j) * (X(1) @ X(2) @ X(3))
            + (0.48296291314453416 + 0j) * (X(1) @ Y(2) @ Y(3))
            + (0.9330127018922193 + 0j) * (X(1) @ X(3))
            + (-0.24999999999999994 + 0j) * (X(1) @ Z(2) @ X(3))
            + (0.48296291314453416 + 0j) * (Y(1) @ Y(2) @ X(3))
            + (-0.48296291314453416 + 0j) * (Y(1) @ X(2) @ Y(3))
            + (0.9330127018922193 + 0j) * (Y(1) @ Y(3))
            + (-0.24999999999999994 + 0j) * (Y(1) @ Z(2) @ Y(3))
            + (-0.12940952255126037 + 0j) * (Z(0) @ X(1) @ X(2) @ X(3))
            + (-0.12940952255126037 + 0j) * (Z(0) @ X(1) @ Y(2) @ Y(3))
            + (-0.24999999999999994 + 0j) * (X(3) @ Z(0) @ X(1))
            + (0.06698729810778066 + 0j) * (Z(0) @ X(1) @ Z(2) @ X(3))
            + (-0.12940952255126037 + 0j) * (Z(0) @ Y(1) @ Y(2) @ X(3))
            + (0.12940952255126037 + 0j) * (Z(0) @ Y(1) @ X(2) @ Y(3))
            + (-0.24999999999999994 + 0j) * (Y(3) @ Z(0) @ Y(1))
            + (0.06698729810778066 + 0j) * (Z(0) @ Y(1) @ Z(2) @ Y(3))
            + (0.25000000000000006 + 0j) * (X(2) @ X(3) @ X(4) @ X(5))
            + (0.25000000000000006 + 0j) * (X(2) @ X(3) @ Y(4) @ Y(5))
            + (0.48296291314453416 + 0j) * (X(5) @ X(2) @ X(3))
            + (-0.12940952255126037 + 0j) * (X(2) @ X(3) @ Z(4) @ X(5))
            + (0.25000000000000006 + 0j) * (Y(2) @ X(3) @ Y(4) @ X(5))
            + (-0.25000000000000006 + 0j) * (Y(2) @ X(3) @ X(4) @ Y(5))
            + (0.48296291314453416 + 0j) * (Y(5) @ Y(2) @ X(3))
            + (-0.12940952255126037 + 0j) * (Y(2) @ X(3) @ Z(4) @ Y(5))
            + (-0.25000000000000006 + 0j) * (X(2) @ Y(3) @ Y(4) @ X(5))
            + (0.25000000000000006 + 0j) * (X(2) @ Y(3) @ X(4) @ Y(5))
            + (-0.48296291314453416 + 0j) * (Y(5) @ X(2) @ Y(3))
            + (0.12940952255126037 + 0j) * (X(2) @ Y(3) @ Z(4) @ Y(5))
            + (0.25000000000000006 + 0j) * (Y(2) @ Y(3) @ X(4) @ X(5))
            + (0.25000000000000006 + 0j) * (Y(2) @ Y(3) @ Y(4) @ Y(5))
            + (0.48296291314453416 + 0j) * (X(5) @ Y(2) @ Y(3))
            + (-0.12940952255126037 + 0j) * (Y(2) @ Y(3) @ Z(4) @ X(5))
            + (0.48296291314453416 + 0j) * (X(3) @ X(4) @ X(5))
            + (0.48296291314453416 + 0j) * (X(3) @ Y(4) @ Y(5))
            + (0.9330127018922193 + 0j) * (X(3) @ X(5))
            + (-0.24999999999999994 + 0j) * (X(3) @ Z(4) @ X(5))
            + (0.48296291314453416 + 0j) * (Y(3) @ Y(4) @ X(5))
            + (-0.48296291314453416 + 0j) * (Y(3) @ X(4) @ Y(5))
            + (0.9330127018922193 + 0j) * (Y(3) @ Y(5))
            + (-0.24999999999999994 + 0j) * (Y(3) @ Z(4) @ Y(5))
            + (-0.12940952255126037 + 0j) * (Z(2) @ X(3) @ X(4) @ X(5))
            + (-0.12940952255126037 + 0j) * (Z(2) @ X(3) @ Y(4) @ Y(5))
            + (-0.24999999999999994 + 0j) * (X(5) @ Z(2) @ X(3))
            + (0.06698729810778066 + 0j) * (Z(2) @ X(3) @ Z(4) @ X(5))
            + (-0.12940952255126037 + 0j) * (Z(2) @ Y(3) @ Y(4) @ X(5))
            + (0.12940952255126037 + 0j) * (Z(2) @ Y(3) @ X(4) @ Y(5))
            + (-0.24999999999999994 + 0j) * (Y(5) @ Z(2) @ Y(3))
            + (0.06698729810778066 + 0j) * (Z(2) @ Y(3) @ Z(4) @ Y(5))
            + (0.25000000000000006 + 0j) * (X(4) @ X(5) @ X(6) @ X(7))
            + (0.25000000000000006 + 0j) * (X(4) @ X(5) @ Y(6) @ Y(7))
            + (0.48296291314453416 + 0j) * (X(7) @ X(4) @ X(5))
            + (-0.12940952255126037 + 0j) * (X(4) @ X(5) @ Z(6) @ X(7))
            + (0.25000000000000006 + 0j) * (Y(4) @ X(5) @ Y(6) @ X(7))
            + (-0.25000000000000006 + 0j) * (Y(4) @ X(5) @ X(6) @ Y(7))
            + (0.48296291314453416 + 0j) * (Y(7) @ Y(4) @ X(5))
            + (-0.12940952255126037 + 0j) * (Y(4) @ X(5) @ Z(6) @ Y(7))
            + (-0.25000000000000006 + 0j) * (X(4) @ Y(5) @ Y(6) @ X(7))
            + (0.25000000000000006 + 0j) * (X(4) @ Y(5) @ X(6) @ Y(7))
            + (-0.48296291314453416 + 0j) * (Y(7) @ X(4) @ Y(5))
            + (0.12940952255126037 + 0j) * (X(4) @ Y(5) @ Z(6) @ Y(7))
            + (0.25000000000000006 + 0j) * (Y(4) @ Y(5) @ X(6) @ X(7))
            + (0.25000000000000006 + 0j) * (Y(4) @ Y(5) @ Y(6) @ Y(7))
            + (0.48296291314453416 + 0j) * (X(7) @ Y(4) @ Y(5))
            + (-0.12940952255126037 + 0j) * (Y(4) @ Y(5) @ Z(6) @ X(7))
            + (0.48296291314453416 + 0j) * (X(5) @ X(6) @ X(7))
            + (0.48296291314453416 + 0j) * (X(5) @ Y(6) @ Y(7))
            + (0.9330127018922193 + 0j) * (X(5) @ X(7))
            + (-0.24999999999999994 + 0j) * (X(5) @ Z(6) @ X(7))
            + (0.48296291314453416 + 0j) * (Y(5) @ Y(6) @ X(7))
            + (-0.48296291314453416 + 0j) * (Y(5) @ X(6) @ Y(7))
            + (0.9330127018922193 + 0j) * (Y(5) @ Y(7))
            + (-0.24999999999999994 + 0j) * (Y(5) @ Z(6) @ Y(7))
            + (-0.12940952255126037 + 0j) * (Z(4) @ X(5) @ X(6) @ X(7))
            + (-0.12940952255126037 + 0j) * (Z(4) @ X(5) @ Y(6) @ Y(7))
            + (-0.24999999999999994 + 0j) * (X(7) @ Z(4) @ X(5))
            + (0.06698729810778066 + 0j) * (Z(4) @ X(5) @ Z(6) @ X(7))
            + (-0.12940952255126037 + 0j) * (Z(4) @ Y(5) @ Y(6) @ X(7))
            + (0.12940952255126037 + 0j) * (Z(4) @ Y(5) @ X(6) @ Y(7))
            + (-0.24999999999999994 + 0j) * (Y(7) @ Z(4) @ Y(5))
            + (0.06698729810778066 + 0j) * (Z(4) @ Y(5) @ Z(6) @ Y(7)),
        ),
    ],
)
def test_bose_hubbard_hamiltonian_matrix(shape, n_cells, hopping, interaction, expected_ham):
    r"""Test that the correct Bose-Hubbard Hamiltonian is generated."""

    bose_hub_ham = bose_hubbard(
        lattice=shape, n_cells=n_cells, hopping=hopping, interaction=interaction
    )
    coeffs, ops = expected_ham.terms()
    expected_ham = qml.ops.op_math.LinearCombination(coeffs, ops)
    qml.assert_equal(bose_hub_ham, expected_ham)
