...
class TestProcessSamples:
    ...
    def test_counts_all_outcomes_measurement_value_list(self):
        ...
        result2 = qp.counts([m0, m1], all_outcomes=True).process_samples(samples, wire_order=[0, 1])
...
class TestCountsIntegration:
    ...
    @pytest.mark.pl2do(reason="parameter broadcasting not supported with Operator2.")
