...
* ``qml.transforms.hamiltonian_expand``, ``qml.transforms.sum_expand`` and 
  ``qml.transforms.split_non_commuting`` have been deprecated. Users are redirected to the new 
