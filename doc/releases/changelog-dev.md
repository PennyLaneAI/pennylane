...
* `qml.sample`, `qml.probs`, and `qml.counts` now raise warnings if wires as passed as
  observables or observables are passed as wires and correctly initializes the measurement
  process.
