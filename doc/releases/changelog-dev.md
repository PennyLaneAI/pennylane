...
* The default behaviour of `qml.from_qasm()` to remove measurements in the QASM code is deprecated. Use `measurements=[]` to keep this behaviour of `measurements=None` to keep the measurements from the QASM code.
