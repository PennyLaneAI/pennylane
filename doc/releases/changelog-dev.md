...
* Support for using TensorFlow with PennyLane has been deprecated and will be dropped in Pennylane v0.44.
  ...
  Instead, we recommend using the :doc:PyTorch </demos/tutorial_qnn_module_torch>
:doc:JAX </demos/tutorial_How_to_optimize_QML_model_using_JAX_and_Optax>. interface for
