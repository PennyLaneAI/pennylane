...
* The inspectibility of general symbolic decomposition rules are improved. The string representation of a decomposition rule
  is by default its source code. Now for symbolic decomposition rules that wraps a base decomposition rule, the source code
