...
* The following legacy operators are now ported to the new `~.Operator2` base class.
  ...
  - Parametric operators are ported:
    - :class:`~.RZ`, :class:`~.CRZ`, :class:`~.DiagonalQubitUnitary`, :class:`~.PauliRot`, :class:`~.MultiRZ`, :class:`~.Rot`, :class:`~.CRot`, :class:`~.RX`, :class:`~.CRX`.
  ...
  - Templates are ported:
    - `~.BasisRotation`, `~.MultiplexerStatePreparation`, `~.QROM`, `~.QFT`, `~.FlipSign`
