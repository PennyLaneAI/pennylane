...
using the default NumPy/autograd QNode interface, we'll use the :ref:`Torch QNode <torch_interf>`.
...
.. note:: For more details on the PyTorch interface, see :ref:`here <torch_interf>`.
