...
.. figure:: ../tutorials/figures/rotation_circuit.svg
    :align: center
    :width: 40%
...
#     * combine quantum functions (evaluated on quantum hardware/simulators) and classical
...
#     :class: defn
#
#     Any computational object that can apply quantum operations, and return an expectation
#     value is called a quantum **device**.
#
...
#
#
# PennyLane supports devices using both the qubit model of quantum computation and
# devices using the CV model of quantum computation.
...
###############################################################################
# The optimization converges after approximately 40 steps, giving the following numerically optimum values of
