...
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
| ``None``                         | ``"device"``              |    1         |          1             |          1       |   1        |     1           |     1          |    1           |  1   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"backprop"``            |    1         |          1             |          1       |   1        |     1           |     1          |    1           |  1   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"adjoint"``             |    2         |          2             |          2       |   2        |     2           |     2          |    2           |  2   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"parameter-shift"``     |    2         |          2             |          2       |   2        |     2           |     2          |    2           |  2   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"finite-diff"``         |    2         |          2             |          2       |   2        |     2           |     2          |    2           |  2   |
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
| ``"autograd"``                   | ``"device"``              |    3         |          3             |          3       |   3        |     3           |     3          |    3           |  3   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"backprop"``            |     4        |        4               |         4        |    4       |    5            |      5         |       5        |  5   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"adjoint"``             |      6       |            6           |        6         |    6       |       7         |       7        |       7        |  6   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"parameter-shift"``     |      4       |         4              |      4           |  4         |      8          |      8         |      8         |  8   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"finite-diff"``         |     4        |          4             |      4           |    4       |       8         |       8        |      8         |   8  |
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
| ``"jax"``                        | ``"device"``              |    3         |          3             |          3       |   3        |     3           |     3          |    3           |  3   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"backprop"``            |     4        |        4               |         4        |    4       |    5            |      5         |       5        |  5   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"adjoint"``             |      6       |            6           |        6         |    6       |       7         |       7        |       7        |  6   |
...
|                                  | ``"finite-diff"``         |      4       |         4              |      4           |  4         |      8          |      8         |      8         |  8   |
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
| ``"tf"``                         | ``"device"``              |    3         |          3             |          3       |   3        |     3           |     3          |    3           |  3   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"backprop"``            |     9        |        9               |         9        |   10       |  9              |      9         |  9             |  9   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"adjoint"``             |      6       |            6           |        6         |    6       |       7         |       7        |       7        |  6   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"parameter-shift"``     |    11        |         11             |        12        |    ?       |      8          |       8        |     8          |  8   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"finite-diff"``         |     ?        |        ?               |        12        |    ?       |      8          |       8        |     8          |  8   |
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
| ``"torch"``                      | ``"device"``              |    3         |          3             |          3       |   3        |     3           |     3          |    3           |  3   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"backprop"``            |     4        |        4               |         4        |    4       |    5            |      5         |       5        |  5   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"adjoint"``             |      6       |            6           |        6         |    6       |       7         |       ?        |       7        |  6   |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"parameter-shift"``     |      4       |            4           |    4             |     ?      |      8          |      ?         |        8       |   8  |
+                                  +---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+
|                                  | ``"finite-diff"``         |      4       |            4           |    4             |     ?      |      8          |      ?         |        8       |   8  |
+----------------------------------+---------------------------+--------------+------------------------+------------------+------------+-----------------+----------------+----------------+------+

1. Not supported. Gradients are not computed even though ``diff_method`` is provided. Fails with error.
2. Supported. Gradients are not computed even though ``diff_method`` is provided. Warns that no auto-differentiation framework is being used, but does not fail.
3. Not supported. The ``default.qubit`` device does not provide a native way to compute gradients.
4. Not supported. Gradients are only defined for real scalar-valued functions.
5. Supported, but only when ``shots>0``.
...
8. Supported.
9. Supported, but only when ``shots>0``. Tensorflow aggregates across all dimensions of the output to compute the gradient.
10. Not supported. Back-propagation requires that ``shots=None``, but sample-based measurements require that ``shots>0``.
11. Not supported. Gradients are not defined for circuits that return the state.
12. Supported. Tensorflow aggregates across all dimensions of the output to compute the gradient.
