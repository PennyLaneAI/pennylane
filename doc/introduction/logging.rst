...
Viewing the existing logging configuration file is possible by calling the :func:`pennylane.logging.edit_system_config` functionm which will open the file in an existing browser or editor window.
