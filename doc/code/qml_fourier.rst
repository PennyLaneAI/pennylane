...
Calculating the frequencies supported by an encoding strategy
-------------------------------------------------------------
...
we have to compute the Fourier *coefficients* :math:`c_{n_1,\ldots,n_N}`. This can be achieved with the
