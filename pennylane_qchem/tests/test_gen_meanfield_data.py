...
def test_path_to_hf_data(names, tmpdir):
    ...
    path_to_hf_data = qchem.gen_meanfield_data(mol_name,
                                               geometry,
                                               charge,
                                               multiplicity,
                                               basis,
...
@pytest.mark.parametrize("names", ['Psi4', 'PySCF'])
def test_hf_calculations(names, tmpdir, tol):
    ...
    one_body_integrals = np.array([[-1.27785300e+00, 1.11022302e-16],
                                   [0.00000000e+00, -4.48299698e-01]])

    two_body_integrals = np.array([[[[6.82389533e-01, 0.00000000e+00],
                                     [6.93889390e-17, 1.79000576e-01]],
                                    [[4.16333634e-17, 1.79000576e-01],
                                     [6.70732778e-01, 0.00000000e+00]]],
                                   [[[5.55111512e-17, 6.70732778e-01],
                                     [1.79000576e-01, 1.11022302e-16]],
                                    [[1.79000576e-01, 0.00000000e+00],
                                     [2.77555756e-17, 7.05105632e-01]]]])
...
def test_not_available_qc_package(names, tmpdir):
    ...
    with pytest.raises(TypeError,
        ...
        qchem.gen_meanfield_data(mol_name,
                                 geometry,
                                 charge,
                                 multiplicity,
                                 basis,
