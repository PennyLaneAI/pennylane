...
* A new differentiation method has been added for use with simulators in tape mode. The "rewind"
  ...
  @qml.qnode(device, diff_method="rewind")
  def f(params):
      qml.RX(0.1, wires=0)
  ...
  This method is provided through the `RewindTape` quantum tape.
