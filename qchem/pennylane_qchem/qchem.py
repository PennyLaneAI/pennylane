...
def ph_pphh_wires(ph_confs, pphh_confs, wires=None):
    ...
    """Map the indices representing the 1particle-1hole (``ph_confs``) and 2particle-2hole
    configurations (``pphh_confs``) generated by the Coupled-Cluster excitation operator
    to the wires that the Unitary Coupled-Cluster Singles and Doubles (UCCSD) template
    will act on.
