...
def active_space(n_electrons, n_orbitals, mult=1, nact_els=None, nact_orbs=None):
    ...
    that are generated by exciting electrons from the occupied to the unoccupied HF orbitals.
    Since the number of configurations increases combinatorially with the number of electrons
    and orbitals this expansion is can be truncated by defining an active space. 
    ...
    .. note::
        ...
        qubits required to perform quantum simulations of the electronic structure of the
        molecule.
