...
def excitations(n_electrons, n_orbitals, delta_sz=0):
	...
	referred to as virtual (virt), HF orbitals and :math:`\hat c` and
    ...
    Returns:
        tuple(list, list): lists with the indices of the orbitals involved in the
        single and double excitations

    **Example**

    >>> ph, pphh = excitations(2, 4, 0)
    >>> print(ph)
    [[0, 2], [1, 3]]
    >>> print(pphh)
    [[0, 1, 2, 3]]
