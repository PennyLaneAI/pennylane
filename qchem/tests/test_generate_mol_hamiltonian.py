...
@pytest.mark.parametrize(('mol_name', 'geo_file', 'charge', 'multiplicity',
                          'qc_prog', 'n_act_electrons', 'n_act_orbitals',
                          'transformation'),
...
def test_building_hamiltonian(mol_name,
                              geo_file,
                              charge,
                              multiplicity,
                              qc_prog,
    ...
    built_hamiltonian, n_qubits = \
        qchem.generate_mol_hamiltonian(mol_name,
                                       geo_file,
                                       charge,
                                       multiplicity,
                                       'sto-3g',
