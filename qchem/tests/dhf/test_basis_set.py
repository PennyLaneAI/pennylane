...
class TestBasis:
    ...
    def test_basisfunction(self, basis_data):
        ...
        basis_function = qchem.dhf.BasisFunction(l, alpha, coeff, r)
    ...
    def test_atom_basis_data(self, basis_data):
        ...
        params = qchem.dhf.atom_basis_data(basis, symbol)[0]
    ...
    def test_mol_basis_data(self, basis_data):
        ...
        n_basis, params = qchem.dhf.mol_basis_data(basis, symbols)
